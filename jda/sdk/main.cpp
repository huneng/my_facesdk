...
int main_detect_video(int argc, char **argv){
    ...
    init_detect_factor(detector, 0.2, 1.0, 0.1, 0.1, 12);
...
int main_generate_samples(int argc, char **argv)
{
    ...
    init_detect_factor(detector, 0.1, 0.9, 0.1, 0.1, 15);
...
int main_detect_images(int argc, char **argv)
{
    ...
    init_detect_factor(detector, 0.1, 1.0, 0.1, 0.1, 10);
...
int main_detect_images_fddb(int argc, char **argv)
{
    ...
    init_detect_factor(detector, 0.05, 0.95, 0.05, 0.05, 20);
    for(int i = 0; i < size; i++){
