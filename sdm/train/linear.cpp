...
void l2r_l2_svc_fun::Hv(double *s, double *Hs)
{
    ...
    memset(Hs, 0, sizeof(double) * w_size);
        ...
        double Cp, double Cn, int solver_type)
{
    ...
    for(i = 0; i < l; i ++)
    {
        ...
        QD[i] = diag[GETI(i)] + sparse_operator::nrm2_sq(xi);
...
static void solve_l2r_l1l2_svr( const problem *prob, double *w, const parameter *param, int solver_type)
{
    int l = prob->l;
    int w_size = prob->n;
...
model* train(const problem *prob, const parameter *param)
{
    ...
    if(check_regression_model(model_))
    {
        ...
        memset(model_->w, 0, sizeof(double) * w_size);
